...
boot_map_region(kern_pgdir,(uintptr_t) UPAGES,npages*sizeof(struct PageInfo), PADDR(pages), PTE_U | PTE_P);
	...
	// LAB 3: Your code here.
boot_map_region(kern_pgdir,(uintptr_t)UENVS,PTSIZE,PADDR(envs),PTE_U | PTE_P);
	//////////////////////////////////////////////////////////////////////
...
{
	if(pp->pp_ref!=0){
		panic("the pp_ref should reaches 0");
	}
...
boot_map_region(pde_t *pgdir, uintptr_t va, size_t size, physaddr_t pa, int perm)
{
	// Fill this function in
	pte_t * pt;
	for(uint32_t i=0;i<size/PGSIZE;i++){
...
mmio_map_region(physaddr_t pa, size_t size)
{
	...
	if((size+base>MMIOLIM)||(size +base< base)){
